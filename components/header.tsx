    ...
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center h-[4.5rem]">
          ...
          <Link
            href="/subscribe"
            className="inline-flex bg-foreground text-background px-5 sm:px-8 mr-3 md:mr-0 items-center justify-center h-12 sm:self-stretch sm:h-auto font-bold text-[10px] sm:text-[11px] tracking-[0.15em] btn-subscribe transition-all duration-300"
          >
            SUBSCRIBE
          </Link>
